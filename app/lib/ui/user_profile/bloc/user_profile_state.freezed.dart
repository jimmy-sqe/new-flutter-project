...
abstract class $UserProfileStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int userId, String userName, String userEmail});
}
...
class _$UserProfileStateImpl implements _UserProfileState {
  const _$UserProfileStateImpl(
      {this.userId = 0, this.userName = '', this.userEmail = ''});
  ...
  @override
  String toString() {
    return 'UserProfileState(userId: $userId, userName: $userName, userEmail: $userEmail)';
  }
...
abstract class _UserProfileState implements UserProfileState {
  const factory _UserProfileState(
      {final int userId,
      final String userName,
      final String userEmail}) = _$UserProfileStateImpl;
