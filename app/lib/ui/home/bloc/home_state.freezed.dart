...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String welcomeMessage});
}
...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({this.welcomeMessage = ''});
  ...
  @override
  String toString() {
    return 'HomeState(welcomeMessage: $welcomeMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, welcomeMessage);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({final String welcomeMessage}) = _$HomeStateImpl;
